    ...
    >
      <div class="card-container">
        ...
        <script>
          ...
          for (const jurusan in mataPelajaran) {
            const card = document.createElement("div");
            card.classList.add("card");

            const cardTitle = document.createElement("div");
            cardTitle.classList.add("card-title");
            cardTitle.textContent = jurusan;
            card.appendChild(cardTitle);

            const mataPelajaranContainer = document.createElement("div");
            mataPelajaranContainer.classList.add("mata-pelajaran");

            const ul = document.createElement("ul");
            mataPelajaran[jurusan].forEach((mataPelajaranItem) => {
              const li = document.createElement("li");
              li.textContent = mataPelajaranItem;
              ul.appendChild(li);
            });

            mataPelajaranContainer.appendChild(ul);
            card.appendChild(mataPelajaranContainer);
